import { AudioConfig, CancellationEventArgs, Conversation, ConversationInfo, Meeting, MeetingInfo, MeetingTranscriber, PropertyCollection, Recognizer, SpeechRecognitionEventArgs, SpeechTranslationConfig } from "../../sdk/Exports";
...
export declare class TranscriberRecognizer extends Recognizer {
    ...
    checkAudioConfiguration(): Promise<void>;
