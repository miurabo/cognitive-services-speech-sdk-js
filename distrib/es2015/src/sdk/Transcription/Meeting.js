...
export class Meeting {
     ...
     * @param err
     */
    static createMeetingAsync(speechConfig, arg2, arg3, arg4) {
        ...
        if (typeof arg2 === "string") {
            ...
            // eslint-disable-next-line @typescript-eslint/no-empty-function
            marshalPromiseToCallbacks((() => __awaiter(this, void 0, void 0, function* () { }))(), arg2, arg3);
        }
        return meetingImpl;
    }
}
export class MeetingImpl extends Meeting {
    ...
    connectTranscriberRecognizer(recognizer) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            yield recognizer.checkAudioConfiguration();
